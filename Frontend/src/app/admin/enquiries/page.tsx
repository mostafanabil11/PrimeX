      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <select
            ...
            className="border border-border bg-surface-2 px-3 py-2 text-[12px] text-foreground focus:border-ring focus:outline-none"
          >
            {STATUSES.map((s) => (
              <option key={s} value={s}>
                {STATUS_LABELS[s]}
      ...
      {isNoteOpen && (
        <div className="mt-4 flex flex-col gap-2 border-t border-border pt-3">
          <textarea
            ...
            aria-label="Note"
            className="w-full resize-y border border-border bg-surface-2 px-3 py-2 text-[13px] text-foreground focus:border-ring focus:outline-none"
          />
          <button
            type="button"
